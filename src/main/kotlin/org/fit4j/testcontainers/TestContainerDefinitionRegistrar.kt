...
class TestContainerDefinitionRegistrar(private val definition: TestContainerDefinition, private val network: Network) {
    ...
    fun register(context:ConfigurableApplicationContext) {
        ...
        definition.getContainer().withNetwork(network).withNetworkAliases(definition.beanName)
