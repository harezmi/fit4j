...
| **FIT4J** | **<!--fit4jVersion-->0.1.6<!--/fit4jVersion-->+** | This release line targets Spring Boot **4.1.x**. **<!--fit4jVersion-->0.1.6<!--/fit4jVersion-->** makes gRPC starters optional (single JAR for HTTP/DB/Kafka FITs). Use FIT4J **0.0.x** (or earlier) with Spring Boot 3.5. |
...
- **Spring Boot:** Use **4.1.x** with FIT4J **<!--fit4jVersion-->0.1.6<!--/fit4jVersion-->+**. Migrating from Boot 3.5? See **[BOOT4_MIGRATION.md](BOOT4_MIGRATION.md)** (gRPC, HTTP, Jackson, Testcontainers 2.0).
...
dependencies {
    ...
    testImplementation("io.github.harezmi:fit4j:0.1.6")
}
```
<!--/fit4jVersion-->
