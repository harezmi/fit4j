# Acceptance Tests Library Usage Examples

This project contains examples of how to use [Udemy Acceptance Tests Library](https://github.com/udemy/library-service-acceptance-tests) 
with various other libraries and frameworks. The example projects are completely self-contained. They can be run independently. 
...
* [Event Tracking](example-event-tracking/) contains test examples to demonstrate how to write acceptance tests for event tracking using Udemy Event Tracking Library.
* [Experimentation Platform](example-experimentation-platform/) contains test examples to demonstrate how to write acceptance tests using Udemy Experimentation Platform Library.
