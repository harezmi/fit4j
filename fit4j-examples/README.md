...
**Build notes:** Examples share the same toolchain as the main library — JDK **25** for compile/test (Gradle auto-provisioned), **Java 17** bytecode, Spring Boot **4.1.x**, FIT4J **<!--fit4jVersion-->0.1.9<!--/fit4jVersion-->**. Version pins live in [`gradle.properties`](gradle.properties).
